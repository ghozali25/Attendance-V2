...
class EnsureSecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $cspConfig = [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://unpkg.com https://cdn.jsdelivr.net http://attendance-v2-zeta.vercel.app https://attendance-v2-zeta.vercel.app",
